...
2. **R Packages (2e)** Book on how to *make* those R packages you downloaded from CRAN https://r-pkgs.org/
...
🏅Sports
1. :football: nflFastR https://nflfastr.com/articles/nflfastR.html
2. :basketball: HoopR https://hoopr.sportsdataverse.org/articles/getting-started-hoopR.html
3. :cricket_game: cricketR https://gigadom.in/2015/07/04/introducing-cricketr-a-r-package-to-analyze-performances-of-cricketers/
...
Add'l <https://tug.org/begin.html>
